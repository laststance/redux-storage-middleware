...
describe('isServer', () => {
  test('returns false in browser environment', () => {
...
describe('isBrowser', () => {
  ...
  test('correctly detects browser with window object', () => {
    expect(typeof window).toBe('object')
    expect(isBrowser()).toBe(true)
  })
})
...
describe('isStorageAvailable', () => {
  ...
  test('verifies localStorage operations work', () => {
...
describe('isSessionStorageAvailable', () => {
  ...
  test('returns true when sessionStorage is available', () => {
    expect(isSessionStorageAvailable()).toBe(true)
  })

  test('verifies sessionStorage operations work', () => {
...
describe('SSR Detection Logic', () => {
  test('isServer and isBrowser are mutually exclusive', () => {
    // These should always be opposite values
    expect(isServer()).not.toBe(isBrowser())
  })

  test('in browser mode, isBrowser is true and isServer is false', () => {
    expect(isBrowser()).toBe(true)
    expect(isServer()).toBe(false)
  })
})
