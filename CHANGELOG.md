...
- Empty storage, a failed migration, and a version mismatch all call `onFinishHydration` and `onHydrationComplete`.
- `clearStorage` cancels a pending debounce, throttle, or idle save.
